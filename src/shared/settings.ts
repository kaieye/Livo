...
export function isLegacyDefaultSystemPromptTemplate(template: string | undefined): boolean {
...
function normalizeContentWidth(
  ...
  const contentMaxWidth =
    Number.isFinite(general.contentMaxWidth) && general.contentMaxWidth > 0
      ...
      : Number.isFinite(general.customContentMaxWidth) && general.customContentMaxWidth > 0
