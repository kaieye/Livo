...
export const SocialOverlayHeader = memo(function SocialOverlayHeader({
  ...
  return (
    <div className="drag-region reader-titlebar-toolbar-pt border-border/10 dark:border-border-dark/10 dark:bg-surface-dark/95 sticky top-0 z-20 border-b bg-white/95 backdrop-blur-sm">
      <div
        className={`no-drag ${contentWidthClass} mx-auto flex h-9 items-center justify-between px-4`}
