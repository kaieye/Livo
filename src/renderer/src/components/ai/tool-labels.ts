// Friendly Chinese labels for agent tool names (移植自 Harmony 端 AIChatToolLabels.ts).
// Used by the run status bar and trace panel so users see human-readable tool
// names instead of raw identifiers like `list_subscribed_feeds`.
