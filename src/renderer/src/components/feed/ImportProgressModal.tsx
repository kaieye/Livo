...
export function ImportProgressModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50">
      <div className="w-[420px] space-y-4 rounded-xl bg-white p-6 shadow-2xl dark:bg-surface-dark-secondary">
        ...
        <div className="space-y-2">
          <div className="h-2.5 w-full overflow-hidden rounded-full bg-surface-secondary dark:bg-surface-dark">
            <div
