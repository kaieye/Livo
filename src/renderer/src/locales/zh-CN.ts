...
import { zhCNAccountLogin } from './zh-CN/account-login'
...
export const zhCN = {
  ...
  aiChat: {
    ...
    suggestion1: '提炼当前文章的核心判断和依据',
    suggestion2: '找出今天更新里最值得先读的内容',
    suggestion3: '根据我的订阅，建议一个接下来可关注的主题',
