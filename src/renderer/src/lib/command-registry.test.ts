...
import { handleRegisteredShortcutEvent, registerCommand, resetCommandRegistry } from "./command-registry"
import { registerOverlayHotkeyScope, resetHotkeyScopeState, setFocusedHotkeyScope } from "./hotkey-scope"
...
describe("command registry", () => {
  ...
  it("blocks commands when a blocked overlay scope is active", () => {
    ...
    const handled = handleRegisteredShortcutEvent(createKeyboardEvent("r", { ctrlKey: true }))
    disposeOverlay()
