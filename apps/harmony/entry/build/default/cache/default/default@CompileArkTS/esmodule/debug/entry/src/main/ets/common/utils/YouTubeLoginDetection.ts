import { extractYouTubeProfileName } from "@bundle:com.livo.harmony/entry/ets/common/utils/YouTubeProfileResolver";
...
export function detectYouTubeLoginState(input: YouTubeLoginDetectionInput): YouTubeLoginDetectionResult {
    ...
    const inLoginFlow = isLoginHost(host) && !(sessionCookie && hasProfileEvidence);
