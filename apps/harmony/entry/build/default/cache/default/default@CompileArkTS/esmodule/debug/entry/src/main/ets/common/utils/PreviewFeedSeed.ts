...
function createEntryId(feedId: string, entryId: string, link: string, title: string, index: number): string {
...
export function rekeyPreviewEntries(feedId: string, entries: PreviewSeedEntry[]): PreviewSeedEntry[] {
