...
export function AIChatPanel() {
  ...
  return (
    <div
      ref={panelRef}
      className="fixed bg-white dark:bg-surface-dark rounded-2xl shadow-2xl border animate-in zoom-in-95 slide-in-from-bottom-4 duration-200 flex flex-col overflow-hidden"
      style={{
        zIndex,
        left: pixels.x,
        top: pixels.y,
